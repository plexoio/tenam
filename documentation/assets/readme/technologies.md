...
Our project required standardized processes and a variety of essential tools as any other project.

From the beginning to the end, we used the following technologies:

### Coding
- **Gitpod**: Main IDE for the coding process, along with internal extensions such as auto-save, 
- **Visual Studio Code desktop**: Secundaty for coding process, along with internal extensions such as auto-save, boilerplates, markdown and HTML preview, HTML autoindententation, JS autoindentation and more.
- **[Code Institute](https://github.com/Code-Institute-Org/p3-template)**: To deploy Python project.
- **Google Developer Tools**: For testing and debugging.
